      ...
      <div>
        <div>
          <section className="max-w-screen-xl mx-auto relative">
            <h1 className='md:text-[50px] text-[36px] sm:border-b-2 relative z-10 bg-[#fff] w-max mx-auto px-4 py-2 border-b-4 border-orgClr font-[600]'>My Projects</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-24 sm:gap-[80px] items-center sm:mt-20 relative">
              ...
              <a href="https://clevdoc.com/" target='_blank' className='w-4 h-4 rounded-full border-[3px] hidden sm:block border-orgClr absolute left-1/2 -translate-x-1/2 bg-[#fff] z-10 hover:scale-125 ease-in-out duration-200'></a>
              <a href="https://clevdoc.com/" target='_blank' className="flex relative w-full mb-5">
              ...
              <div className="w-full">
                <h3 className="text-[#0B1E59] text-left font-bold md:text-[40px] text-[30px]">ClevDoc Banking</h3>
                <h2 className="text-[#0B1E59] text-left text-lg">(Banking Loan Management)</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:mt-24 sm:gap-[80px] items-center mt-20 relative">
              <div className="w-full">
                <h3 className="text-[rgba(16,16,16,1)] text-right font-bold md:text-[40px] text-[30px]">HitWeb</h3>
                <h2 className="text-[rgba(16,16,16,1)] text-lg text-right">(IT Consultancy and Services Startup)</h2>
                <p className="text-justify mt-2">
              ...
              <a href="https://clevdoc.com/" target='_blank' className='w-4 h-4 rounded-full hidden sm:block border-[3px] border-orgClr absolute left-1/2 -translate-x-1/2 bg-[#fff] z-10 hover:scale-125 ease-in-out duration-200'></a>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:mt-24 mt-32 sm:gap-[80px] items-center relative">
              <div className='h-[2px] left-[20%] right-1/2 bg-orgClr absolute top-1/2 hidden sm:block'></div>
              <a href="https://surya6394.github.io/Itax-easy-website/" target='_blank' className='w-4 h-4 hidden sm:block rounded-full border-[3px] border-orgClr absolute left-1/2 -translate-x-1/2 bg-[#fff] z-10 hover:scale-125 ease-in-out duration-200'></a>
              <a href="https://surya6394.github.io/Itax-easy-website/" target='_blank' className="flex w-full mb-5">
                <div className='relative group hover:scale-105 ease-in-out duration-200 sm:hover:scale-105'>
              ...
              <div className="w-full">
                <h3 className="text-blue-500 text-left font-bold md:text-[40px] text-[30px]">Itax-Easy</h3>
                <h2 className="text-blue-500 text-left text-lg">(Software Development Agency)</h2>
                <p className="text-justify mt-2">
                  HariGurus is a one-stop-shop for all Hindu religious, customs and
                  traditional requirements. Built the complete site from scratch.
                </p>
